    ...
    {isLoading ? (
        ...
        <div className='max-w-md mx-auto overflow-hidden md:max-w-6xl mt-10 ' id='Divx'>
            <div className="flex justify-center">
                <p className='text-[1.7rem] text-[#030d26] font-semibold text-center'>iCloud Unlock</p>
            </div>
        </div>

        <div className='flex justify-center mt-5'>
            <p> <Link to="/">Services</Link> / <span className='text-[#1f88cf]'>iCloud Unlock</span></p>
        </div>
        </motion.div>
        ...
        <div className='max-w-md mx-auto overflow-hidden md:max-w-6xl mt-[5%]'>
            <div className='grid  grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 sm:grid-cols-1 md:grid-cols-2 gap-5'>
                ...
                <div className='bg-[e72ee7ee] h-fit pl-5 pr-3'>
                    <p className='text-[#030d26]'>At our iCloud unlocking service, we provide a high level of
                     unlocking tools that can unlock all versions of locked iCloud. Our team of experts specializes
                      in client privacy and security, ensuring that your personal information is kept confidential at all times. <br /> <br />


                      We understand the frustration of being locked out of your iCloud account, and the anxiety of having your personal
                     information at risk. That's why we provide a fast, reliable, and secure service that can unlock your iCloud account
                      within a matter of hours. Our tools are designed to bypass even the most advanced security systems, giving you access
                       to your iCloud account without any hassle.  <br/>


                        At our iCloud unlocking service, we believe in providing a personalized service that is tailored to your specific
                        needs. We understand that every case is unique, and we will work closely with you to develop a comprehensive strategy
                        that is designed to achieve the best possible outcome for your situation.
                     </p>
                </div>
                </motion.div>
                ...
                <div className='bg-[e72ee7ee] h-fit mb-[30%] radius '>
                        <div className='flex justify-center pt-[5%]'>
                            <img src="icloud-unlock.png" alt="" className='radius__xx'/>
                        </div>
                </div>
                </motion.div>
            </div>
